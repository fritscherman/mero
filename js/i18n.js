...
de: {
  ...
  'tile.editor.s':'Tauchfotos direkt im Browser aufbereiten – mit Presets, die für unsere Tauchplätze optimiert sind.',
  'tile.spots':'Tauchplätze',
  'tile.spots.s':'Unsere Spots rund um Cala Ratjada – Buchten, Bootsplätze, Grotten und Höhlen.',
  'tile.contact':'Kontakt &amp; Anfahrt',
  'tile.contact.s':'Adresse der Tauchbasis, Karte und Website.',
  'tile.web.s':'Kurse, Preise und Buchung auf unserer Website.',
  'back':'← Startseite',
...
en: {
  ...
  'tile.editor.s':'Enhance your dive photos right in the browser – with presets tuned to our dive sites.',
  'tile.spots':'Dive sites',
  'tile.spots.s':'Our spots around Cala Ratjada – bays, boat sites, grottos and caves.',
  'tile.contact':'Contact &amp; directions',
  'tile.contact.s':'Dive center address, map and website.',
  'tile.web.s':'Courses, prices and booking on our website.',
  'back':'← Home',
...
es: {
  ...
  'tile.editor.s':'Mejora tus fotos de buceo en el navegador, con ajustes optimizados para nuestros puntos de buceo.',
  'tile.spots':'Puntos de buceo',
  'tile.spots.s':'Nuestros puntos alrededor de Cala Ratjada: bahías, salidas en barco, grutas y cuevas.',
  'tile.contact':'Contacto y cómo llegar',
  'tile.contact.s':'Dirección del centro, mapa y web.',
  'tile.web.s':'Cursos, precios y reservas en nuestra web.',
  'back':'← Inicio',
