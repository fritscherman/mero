...
de: {
  ...
  'sec.spots':'Tauchplätze Mero Diving','sec.situation':'Situation','sec.filter':'Filter','sec.wm':'Mero-Signatur','sec.check':'Farbcheck',
...
en: {
  ...
  'sec.spots':'Mero Diving dive sites','sec.situation':'Situation','sec.filter':'Filters','sec.wm':'Mero signature','sec.check':'Color check',
...
es: {
  ...
  'sec.spots':'Puntos de buceo Mero Diving','sec.situation':'Situación','sec.filter':'Filtros','sec.wm':'Firma Mero','sec.check':'Control de color',
